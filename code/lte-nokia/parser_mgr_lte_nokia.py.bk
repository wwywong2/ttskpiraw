...
max_num_job_hardlimit = 20 # 8 # max num of job (hard limit)
...
def worker():
	...
	# new format test
	#	exec_str = "/opt/spark/bin/spark-submit --master mesos://zk://mesos_master_01:2181,mesos_master_02:2181,mesos_master_03:2181/mesos --driver-memory 512m --executor-memory 512m --total-executor-cores 2 %s/kpi_parser_lte_nokia.py \"%s\" /mnt/nfskpi/wyang/ttskpiraw/lte-nokia/input_seq/ttskpiraw_NOKIA_LTE_20170614_150027076014_TMO.seq \"imnosrf@mesos_fs_01|%s\" \"client\" &" % (curr_py_dir, jobname, output_dir)
	...
	# new format test
	#	exec_str = "/opt/spark/bin/spark-submit --master mesos://mesos_master_01:7077 --deploy-mode cluster --driver-memory 512m --executor-memory 512m --total-executor-cores 2 --py-files \"file:///home/imnosrf/ttskpiraw/code/lte-nokia/util.py,file:///home/imnosrf/ttskpiraw/code/lte-nokia/xmlparser_lte_nokia.py,file:///home/imnosrf/ttskpiraw/code/lte-nokia/config.ini\" %s/kpi_parser_lte_nokia.py \"%s\" /mnt/nfskpi/wyang/ttskpiraw/lte-nokia/input_seq/ttskpiraw_NOKIA_LTE_20170614_150027076014_TMO.seq \"imnosrf@mesos_fs_01\|%s\" \"cluster\"" % (curr_py_dir, jobname, output_dir)
	# below doesn't work
